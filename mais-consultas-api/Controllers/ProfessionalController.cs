...
namespace mais_consultas_api.Controllers
{
    ...
    public class ProfessionalController : ControllerBase
    {
        ...
        [HttpPost]
        public ActionResult<Professional> Post([FromBody] string name, string service, string provider)
        {
        ...
        [HttpPut("{id}")]
        public ActionResult<Professional> Put(int id, [FromBody] string name, string service, string provider)
        {
